...
const translations = {
  en: {
    ...
    paragraphs: [
      ...
      'With this idea, we are working on writing Knowledge Notes—a companion for students and adults living in the age of AI, helping them understand what to learn and where to go next.',
    ],
    subjectIntro: '',
    subjects: '',
    finalNote: '',
  ...
  ko: {
    ...
    paragraphs: [
      ...
      '이러한 생각을 바탕으로 우리는 AI 시대를 살아가는 학생과 성인들이 무엇을 배우고 다음에 어디로 나아가야 할지 이해하도록 돕는 동반자인 Knowledge Notes를 집필하고 있습니다.',
    ],
    subjectIntro: '',
    subjects: '',
    finalNote: '',
