...
> = {
  en: {
    ...
    paragraphs: [
      'We are a small technology team working to bring the characters of Animal Intelligence into the real world.',
      'Our idea is simple: What if characters were not just something you watch, but something you could live with?',
  ...
  ko: {
    ...
    paragraphs: [
      '우리는 Animal Intelligence의 캐릭터들을 현실 세계로 가져오려는 작은 기술 팀입니다.',
      'Our idea is simple: 캐릭터가 단순히 보는 존재가 아니라, 함께 살 수 있는 존재라면 어떨까요?',
