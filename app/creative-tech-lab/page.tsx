...
> = {
  en: {
    ...
    paragraphs: [
      'We want to make one thing clear: the original Animal Intelligence content and artwork are created by hand. AI is not used to create the original works.',
  ...
  ko: {
    ...
    paragraphs: [
      '한 가지를 분명히 하겠습니다. 동물지능의 원작 콘텐츠와 아트워크는 손으로 직접 만듭니다. 원작 제작에는 AI를 사용하지 않습니다.',
