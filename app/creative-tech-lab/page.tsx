...
> = {
  ...
  ko: {
    ...
    paragraphs: [
      '동물지능 테크랩은 동물지능의 캐릭터들을 현실 세계로 가져오려고 작업하고 있는 작은 기술 팀입니다. 캐릭터가 우리 옆에서 우리와 함께 배우고 성장하고 이야기할 수 있는 존재가 된다면 어떤 느낌일까요?',
      '저희팀의 첫미션은 지식 데이터베이스에 연결된 AI 그리고 그 시스템에 연결된 캐릭터 피규어를 만드는 것입니다.',
    ],
  },
}
