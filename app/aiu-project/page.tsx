...
The fantasy stories follow the animals as they explore, learn, fight, and grow. The knowledge books introduce topics such as science, technology, space, philosophy, economics, and society in a visual and accessible way. The satirical comics use animal characters to reflect on AI, education, power, and the strange direction of the human world.
...
판타지 이야기는 동물들이 탐험하고, 배우고, 싸우고, 성장하는 과정을 따라갑니다. 지식 도서는 과학, 기술, 우주, 철학, 경제, 사회 같은 주제를 시각적이고 접근하기 쉬운 방식으로 소개합니다. 풍자 만화는 동물 캐릭터를 통해 AI, 교육, 권력, 인간 세계의 기묘한 방향을 비춰 봅니다.
